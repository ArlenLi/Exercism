...
public class AcronymTest
{
    ...
    public void Underscore_emphasis()
    {
        ...
        [Fact]
    public void Acronym_number()
    {
        Assert.Equal("B2B", Acronym.Abbreviate("Business 2 Business"));
    }

            [Fact]
    public void Only_quote_and_underscore()
    {
        Assert.Equal("TT", Acronym.Abbreviate("Test '_' Test"));
    }
}